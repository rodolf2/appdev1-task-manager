    ...
    <>
      <div className="flex flex-col justify-center items-center h-screen">
        <div className="formStyle mb-4">
          {" "}
          <h1 className="text-center text-2xl pb-1">Task Manager</h1>
          <h3 className="text-lg text-center font-bold mb-4">Add Task</h3>
          <p className="text-center pb-1 font-extrabold">
